...
function landing() {
  ...
  app.innerHTML = page(`
    ...
    <section class="section" id="pricing" aria-labelledby="price-title"><div class="shell"><div class="price-sheet">
      <div><p class="eyebrow">Business license</p><h2 id="price-title">Keep every recurring visit in the loop</h2><p>Add unlimited client proof links after the three free visits.</p><ul class="plain-list"><li>One business workspace</li><li>Configurable client extras</li><li>Next-visit CSV exports</li></ul></div>
